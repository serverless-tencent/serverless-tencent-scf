...
tencent_appid = 12561*****`);
        ...
        getFunctionResourceStub = sinon.stub(tencentProvider, 'getFunctionResource')
            .returns(true)
        getServiceResourceStub = sinon.stub(tencentProvider, 'getServiceResource')
            .returns(true)
        getEnvironmentStub = sinon.stub(tencentProvider, 'getEnvironment')
            .returns(true)
        getVPCConfigStub = sinon.stub(tencentProvider, 'getVPCConfig')
            .returns(true)
        getCredentialsStub = sinon.stub(tencentProvider, 'getCredentials')
            .returns(true)
        getTimerEventStub = sinon.stub(tencentProvider, 'getTimerEvent')
            .returns(true)
        getCOSEventStub = sinon.stub(tencentProvider, 'getCOSEvent')
            .returns(true)
        getAPIGWEventStub = sinon.stub(tencentProvider, 'getAPIGWEvent')
            .returns(true)
        getCMQEventStub = sinon.stub(tencentProvider, 'getCMQEvent')
            .returns(true)
        getCkafkaEventStub = sinon.stub(tencentProvider, 'getCkafkaEvent')
            .returns(true)
        getDeployCosBucketStub = sinon.stub(tencentProvider, 'getDeployCosBucket')
            .returns(true)
    });
