...
describe('TencentInvoke', () => {
    ...
    describe('#constructor()', () => {
        ...
        describe('hooks', () => {
            ...
            beforeEach(() => {
                validateStub = sinon.stub(tencentInvoke, 'validate')
                    .returns(Promise.resolve());
                setDefaultsStub = sinon.stub(tencentInvoke, 'setDefaults')
                    .returns(Promise.resolve());
                invokeFunctionStub = sinon.stub(tencentInvoke, 'invoke')
                    .returns(Promise.resolve());
            });
            ...
            it('should run "before:invoke:invoke" promise chain', () => tencentInvoke
            ...
            it('should run "invoke:invoke" promise chain', () => tencentInvoke
