                ...
                for (let times = 0; times < 100000; times++) {
                    ...
                    for (var eveLogIndex = 0; eveLogIndex < totalData.length; eveLogIndex++) {
                        if (logsList.indexOf(totalData[eveLogIndex]["RequestId"]) == -1) {
                            ...
                            let outputStr = "\nStartTime: " + totalData[eveLogIndex].StartTime +
                                "\nRetMsg: " + totalData[eveLogIndex].RetMsg +
                                "\nRequestId: " + totalData[eveLogIndex].RequestId +
                                "\n\nDuration: " + totalData[eveLogIndex].Duration +
                                "\nBillDuration: " + totalData[eveLogIndex].BillDuration +
